---
title: Theming
description: How krux's color system and CSS variables work.
---

## CSS Variables

krux uses CSS custom properties scoped to `:root` and `.dark`. All components reference semantic variable names, never hardcoded colors.
...
krux uses a single `--radius` variable (`0.375rem` by default — sharper than shadcn's `0.625rem`):
