---
title: Registry
description: How the krux component registry works.
---

The krux registry is a JSON-based system for distributing component source code. It's how `npx krux add button` knows what to download and install.
...
- **registry dependencies** — other krux components required
...
```json
{
  "$schema": "https://krux.dev/schema/registry-item.json",
  "name": "button",
  "type": "registry:ui",
  "title": "Button",
  ...
  "files": [
    {
      "path": "registry/krux/ui/button.tsx",
