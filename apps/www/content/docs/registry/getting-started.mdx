...
description: Use the mono-ui registry to distribute your own components.
---
...
```bash
npx mono-ui add https://your-domain.dev/r/mono-ui/my-button.json
```
